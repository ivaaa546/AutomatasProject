// Añadir esta línea al inicio de script.js para asegurar que MathJax se renderice bien
window.MathJax = {
    tex: {
        inlineMath: [['$', '$'], ['\\(', '\\)']]
    },
    ...
    chtml: {
        // Asegura que el color de las ecuaciones sea visible en el fondo oscuro
        matchFontHeight: false,
        displayAlign: 'left',
        displayIndent: '2em',
        styles: {
            '.mjx-chtml': {
                color: '#b0b0b0' /* Color para las ecuaciones */
            }
        }
    }
};

// ... el resto de tu código script.js ...
